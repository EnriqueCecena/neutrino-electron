...
Features:
	...
	•	Interactive Plotting: Create scatter plots, line plots, histograms, and custom plots with customizable settings.
	•	Custom Plotting: Generate custom plots based on predefined templates or custom functions.
...
Upon launching, the application presents a multi-page interface with the following sections:
	...
	•	Choose the type of plot to create: Scatter, Line, Histogram, or Custom Plot.
	9.	Figure Creation Page
	•	Customize and generate plots based on selected parameters.
	10.	Custom Figure Page
	•	Generate custom plots based on predefined templates or custom functions.
	11.	Settings Page
...
Note: Ensure that pdg_id_script.py and Custom_Plot_script.py are present in the same directory as Main_Run_File.py for the application to function correctly.
